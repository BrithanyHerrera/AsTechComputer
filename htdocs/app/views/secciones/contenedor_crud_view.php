...
// muestra las operaciones de agregar, editar y eliminar registros en la base de datos. 
//------------------------------------------------------------------------------------------
require_once __DIR__ . "/../../controllers/contenedor_crud_controller.php";
?>
...
<div id="modal-editar-gabinete" class="modal-formulario" style="display: none;">
    <div class="contenido-modal modal-purpura">
        ...
        <form action="../controllers/contenedor_crud_controller.php?accion=editar" method="POST" id="form-editar">
