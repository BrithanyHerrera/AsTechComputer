<?php
/* INGRESAR_DISPOSITIVO_VIEW.PHP */
/*
 * PÁGINA: Ingreso de Dispositivos - As Tech Computer
 * PROPÓSITO: Proporcionar la interfaz gráfica para el registro paso a paso de los equipos recibidos en sucursal.
 * FUNCIONALIDADES: 
 * - Renderización del Asistente Visual (Wizard) indicando en qué paso (del 1 al 5) se encuentra el administrador.
 * - Formulario dinámico dividido en bloques lógicos (Datos del Cliente, Revisión Física, Condiciones Legales, Análisis de Mercado y Datos Técnicos).
 * - Integración de notificaciones de edición (cuando se detecta que el flujo es para actualizar y no para registrar).
 * - Manejo de datos persistentes a través de la variable de sesión `$_SESSION['memoria_ingreso']` para no perder la información al avanzar o retroceder.
 * - Inyección directa de datos desde la BD al JS a través de variables JSON globales para manejar reglas de validación en tiempo real (selectores en cascada).
 *
 * CORRECCIÓN APLICADA:
 * Se eliminó la estructura HTML completa (<!DOCTYPE>, <html>, <head>, <body>) que causaba HTML anidado
 * al incluirse dentro del layout padre (administracion_view.php). El HTML anidado rompía el DOM y
 * deshabilitaba todo JavaScript (botones, validaciones, SweetAlert, selectores en cascada).
 *
 * DEPENDENCIAS — agregar en el <head> de administracion_view.php (o en su sección de estilos/scripts extra):
 *   <link rel="stylesheet" href="../../public/css/ingresar_dispositivo.css">
 *   <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css">
 *   <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
 *   (Al final del <body>): <script src="../../public/js/ingresar_dispositivo.js"></script>
 *
 * Si tu layout ya tiene un mecanismo de inyección de dependencias (p.ej. $extra_css / $extra_js),
 * úsalo. Si no, la forma más simple es declararlas siempre en el <head> del layout padre.
 */
?>
...
<!-- =====================================================
     WIZARD — Indicador de progreso (5 pasos)
     ===================================================== -->
...
<div class="formulario">
    <form method="POST" action="">
        ...
        <?php if ($paso == 1): ?>
            <!-- CORRECCIÓN: Se eliminó el <div class="formulario"> anidado que duplicaba
                 el padding lateral y comprimía el box real del .fila-doble, haciendo
                 que los inputs desbordados fueran visibles pero no interactuables. -->
                ...
                <div class="fila-doble">
                    <div class="grupo-entrada">
                        ...
                        <input type="text" name="nombre_cliente" class="campo-texto"
                               value="<?php echo htmlspecialchars($_SESSION['memoria_ingreso']['nombre_cliente'] ?? ''); ?>"
                               required
                    ...
                    <div class="grupo-entrada">
                        ...
                        <input type="text" name="apellido_cliente" class="campo-texto"
                               value="<?php echo htmlspecialchars($_SESSION['memoria_ingreso']['apellido_cliente'] ?? ''); ?>"
                               required
                               pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ\s]+"
                               title="Solo se permiten letras y espacios."
                               oninput="this.value = this.value.replace(/[^a-zA-ZáéíóúÁÉÍÓÚñÑ\s]/g, '')">
                    ...
                    <div class="grupo-entrada">
                        ...
                        <div class="input-icon-wrapper">
                            ...
                            <input type="tel" name="telefono_cliente" class="campo-texto"
                                   value="<?php echo htmlspecialchars($_SESSION['memoria_ingreso']['telefono_cliente'] ?? ''); ?>"
                                   required
                    ...
                    <div class="grupo-entrada">
                        ...
                        <div class="input-icon-wrapper">
                            ...
                            <input type="email" name="correo_cliente" class="campo-texto"
                                   value="<?php echo htmlspecialchars($_SESSION['memoria_ingreso']['correo_cliente'] ?? ''); ?>"
                                   required
                ...
                <div class="form-acciones">
                    <button type="submit" class="boton-siguiente" name="step" value="2">
            ...
            <div class="fila-doble" style="max-height: none; grid-template-columns: 1fr 1fr;">
                <div class="grupo-entrada">
                    ...
                    <input type="date" name="fecha_ingreso" id="fecha_ingreso" class="campo-texto"
                           value="<?php echo $_SESSION['memoria_ingreso']['fecha_ingreso'] ?? date('Y-m-d'); ?>"
                           required>
                </div>
                ...
                <div class="grupo-entrada">
                    ...
                    <input type="text" name="folio" id="folio_auto" class="campo-texto"
                           value="<?php echo $_SESSION['memoria_ingreso']['folio'] ?? ''; ?>"
                           readonly required>
                </div>
            </div>
        ...
        <?php elseif ($paso == 3): ?>
            ...
            <div class="grupo-entrada">
                ...
                <input type="number" name="tiempo_estimado" class="campo-texto" min="1"
                       value="<?php echo htmlspecialchars($_SESSION['memoria_ingreso']['tiempo_estimado'] ?? ''); ?>">
            </div>
        ...
        <?php elseif ($paso == 5): ?>
            ...
            <div class="fila-doble">
                ...
                <div class="grupo-entrada">
                    ...
                    <input type="text" name="modelo" class="campo-texto"
                           value="<?php echo htmlspecialchars($_SESSION['memoria_ingreso']['modelo'] ?? ''); ?>"
                           required>
                </div>
            </div>
            ...
            <div class="grupo-entrada">
                ...
                <div class="input-icon-wrapper">
                    ...
                    <input type="text" name="numero_serie" class="campo-texto" style="padding-left: 35px;"
                           value="<?php echo htmlspecialchars($_SESSION['memoria_ingreso']['numero_serie'] ?? ''); ?>"
                           required>
                </div>
            </div>
...
<!-- =====================================================
     VARIABLES GLOBALES PARA ingresar_dispositivo.js
     ===================================================== -->
<script>
