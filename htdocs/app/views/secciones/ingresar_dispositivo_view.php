...
<body>
    ...
    <script>
        ...
        // Memoria para reconstruir las selecciones si se recarga la página
        ...
        <?php 
          // Si el controlador guardó un mensaje de éxito, le avisamos al JS para disparar SweetAlert
