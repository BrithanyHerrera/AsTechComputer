<footer class="pie-pagina">
    <div class="contenedor-pie">
        <div class="seccion-logo">
            <img src="<?php echo $ruta_prefijo; ?>public/img/logoATC.png" alt="AS TECH Logo" style="width: 160px; filter: brightness(0) invert(1);">
        </div>
        <div style="display: flex; justify-content: space-around; flex-wrap: wrap; gap: 30px;">
            ...
            <div class="fila-links">
                ...
                <ul>
                    ...
                    <li><a href="<?php echo $ruta_prefijo; ?>app/controllers/convenios_controller.php">Convenios</a></li>
            ...
            <div class="fila-links">
                ...
                <ul>
                    ...
                    <li><a href="<?php echo $ruta_prefijo; ?>app/views/politica_cookies.php">Política de Cookies</a></li>
                </ul>
            </div>
        </div>
