...
/* MAS_INFO_VIEW.PHP */
/*
 * PÁGINA: Vista de Más Información, Contacto y Reseñas (Mas Info View) - As Tech Computer
 * PROPÓSITO: Unificar en una sola interfaz las secciones de contacto directo, ubicación física de la empresa, y la prueba social generada a partir de las reseñas de clientes extraídas desde Google Maps.
 * FUNCIONALIDADES:
 * - Estructuración de un formulario de contacto seguro (método POST) para capturar consultas directas de los usuarios.
 * - Integración de un iFrame con el mapa de Google Maps para facilitar la ubicación de la sucursal.
 * - Renderización condicional (bucle foreach en PHP) de las tarjetas de reseñas obtenidas de forma asíncrona mediante la API de Google Places.
 * - Generación dinámica del resumen general de valoraciones (rating numérico y conteo total), calculando visualmente la cantidad de estrellas a dibujar (estrellas sólidas vs. vacías).
 * - Manejo de estados de retroalimentación mediante la inyección de la variable PHP ($status) hacia JavaScript para detonar modales con SweetAlert2.
 * - Integración de componentes fijos de la arquitectura MVC (Toolbar, Loader, y Footer con sistema de cookies).
 */
?>
<!DOCTYPE html>
<html lang="es">
...
<body>
    <?php 
    // El sistema incluye la pantalla de carga e invoca al controlador 
    // del menú de navegación (Toolbar) para mantener el diseño global.
                ...
                <div class="contenedor-resumen-general">
                    ...
                    <div class="puntuacion-estrellas">
                        <div class="estrellas-grandes">
                            <?php
                            // Bucle para dibujar de forma dinámica las 5 estrellas (llenas o vacías) 
                            // basándose en el redondeo del rating promedio extraído de la API.
                            for ($i = 1; $i <= 5; $i++) {
                    ...
                    <div class="tarjeta-resena">
                        <div class="perfil-resena">
                            ...
                            <div>
                                ...
                                <div class="estrellas">
                                    <?php
                                    // Dibuja las estrellas otorgadas específicamente por el autor de esta reseña
                                    for ($i = 1; $i <= 5; $i++) {
