    ...
    <main>
        <section class="seccion-legal">
            ...
            <ul>
                ...
                <li><strong>Cookies persistentes:</strong> Los datos siguen almacenados en el terminal y pueden ser consultados durante un periodo definido por el responsable (desde unos minutos hasta años), como por ejemplo, recordar sus preferencias de cookies por un año.</li>
            </ul>

            <p><strong>C. Según su finalidad (Clasificación de nuestro Panel de Ajustes):</strong></p>
            <ul>
                <li><strong>1. Cookies Necesarias (o Técnicas):</strong> Son estrictamente esenciales para garantizar la funcionalidad básica y el correcto funcionamiento de nuestro sitio web. Permiten el uso de servicios como el control de tráfico, identificación de sesión, acceso a partes restringidas (Panel Administrativo) y el procesamiento seguro de formularios. Estas cookies <strong>no son opcionales y no se pueden desactivar</strong>.</li>
                <li><strong>2. Cookies Funcionales (o de Personalización):</strong> Permiten a nuestro sitio web ofrecer funciones mejoradas y personalizar su experiencia. Recuerdan opciones predefinidas por el usuario, como el tipo de navegador, proporcionar enlaces específicos y distinguir entre usuarios reales y tráfico automatizado para evitar abusos.</li>
                ...
                <li><strong>4. Cookies Publicitarias:</strong> Se utilizan para mostrarle publicidad relevante basada en sus intereses en otras plataformas. Nos permite compartir información con socios estratégicos (como Google y Meta) para medir conversiones, personalizar contenido y ofrecer información promocional basada en sus datos de navegación.</li>
            </ul>
