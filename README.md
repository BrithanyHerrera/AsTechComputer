...
CLONAR REPOSITORIO A LAPTOP: :
    ...
    2. Clocar en el cmd: git clone https://github.com/BrithanyHerrera/AsTechComputer.git

ANTES DE TIRAR CODIGO, PONER LO SIGUIENTE, PARA BAJAR LOS CAMBIOS:
...
NECESITAN INSTALAR XAMPP Y ACTIVAR EL APACHE (START)
